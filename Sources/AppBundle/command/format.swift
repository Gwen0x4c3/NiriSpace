...
private func toLayoutString(tc: TilingContainer) -> String {
    switch (tc.layout, tc.orientation) {
        ...
        case (.tabbed, .h): return LayoutCmdArgs.LayoutDescription.h_tabbed.rawValue
        case (.tabbed, .v): return LayoutCmdArgs.LayoutDescription.v_tabbed.rawValue
        case (.niri, _): return LayoutCmdArgs.LayoutDescription.niri.rawValue
    }
}
