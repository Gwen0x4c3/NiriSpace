...
== niri-center
----
include::aerospace-niri-center.adoc[tags=synopsis]
----
include::aerospace-niri-center.adoc[tags=purpose]
include::aerospace-niri-center.adoc[tags=body]

== niri-toggle-tags
----
include::aerospace-niri-toggle-tags.adoc[tags=synopsis]
----
include::aerospace-niri-toggle-tags.adoc[tags=purpose]
include::aerospace-niri-toggle-tags.adoc[tags=body]
...
== window-stack
----
include::./aerospace-window-stack.adoc[tags=synopsis]
----
include::./aerospace-window-stack.adoc[tags=purpose]
include::./aerospace-window-stack.adoc[tags=body]

== window-unstack
----
include::./aerospace-window-unstack.adoc[tags=synopsis]
----
include::./aerospace-window-unstack.adoc[tags=purpose]
include::./aerospace-window-unstack.adoc[tags=body]
